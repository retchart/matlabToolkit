...
for iTime = 1:length(TEST_DETECTION_TIME)
    for iCh = 1:length(TEST_COMBINED_CHANNEL)
        ...
        fisherBKGDseq = combinespectra(specSeq_bkgd.Aug4,TEST_DETECTION_TIME(iTime),TEST_COMBINED_CHANNEL(iCh));
        fisherSMPLseq = combinespectra(specSeq_smpl.P13,TEST_DETECTION_TIME(iTime),TEST_COMBINED_CHANNEL(iCh));
        ...
        thisSMPLseq = combinespectra(specSeq_smpl.P23,TEST_DETECTION_TIME(iTime),TEST_COMBINED_CHANNEL(iCh));
