function sgnl = nml_v1(matFileName,plotOrNot,energyStep)
load(matFileName);

%% 刻度能谱
[orgnSpecsgnl,nmlSpecsgnl] = nml1spec(sum(orgnSpecs,2),size(orgnSpecs,2),energyStep,0);
if plotOrNot
    figure;
...
%% 标准化
sgnl = nmlMats(orgnSpecs,orgnSpecsgnl(:,1),nmlSpecsgnl(:,1));
